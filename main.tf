...
# Create a Private-Subnet1,2 part of cloudbinary_vpc 
...
# Create a Public-Subnet2(3,4)part of cloudbinary_vpc 
...
# Create a Public-Subnet3(5,6) part of cloudbinary_vpc 
...
resource "aws_route_table_association" "cloudbinary_subnet_association5" {
  subnet_id      = aws_subnet.cloudbinary_private_subnet3.id
  route_table_id = aws_route_table.cloudbinary_rtb_private.id
}
resource "aws_route_table_association" "cloudbinary_subnet_association6" {
  subnet_id      = aws_subnet.cloudbinary_private_subnet4.id
  route_table_id = aws_route_table.cloudbinary_rtb_private.id
}
resource "aws_route_table_association" "cloudbinary_subnet_association7" {
  subnet_id      = aws_subnet.cloudbinary_private_subnet5.id
  route_table_id = aws_route_table.cloudbinary_rtb_private.id
}
resource "aws_route_table_association" "cloudbinary_subnet_association8" {
  subnet_id      = aws_subnet.cloudbinary_private_subnet6.id
  route_table_id = aws_route_table.cloudbinary_rtb_private.id
}
...
resource "aws_network_acl" "cloudbinary_nsg" {
  ...
  subnet_ids = [
    ...
    "${aws_subnet.cloudbinary_private_subnet3.id}",
    "${aws_subnet.cloudbinary_private_subnet4.id}",
    "${aws_subnet.cloudbinary_private_subnet5.id}",
    "${aws_subnet.cloudbinary_private_subnet6.id}",
  ]
...
resource "aws_instance" "cloudbinary_app" {
  ...
  user_data              = file("./web.sh")
  tags = {
    Name      = "cloudbinary_appserver"
    CreatedBy = "Terraform"
  }
}

# WebServer - Private Subnet 
resource "aws_instance" "cloudbinary_db" {
  ami                    = "ami-053b0d53c279acc90"
  instance_type          = "t2.micro"
  key_name               = "dockerkeypair"
  subnet_id              = aws_subnet.cloudbinary_private_subnet1.id
